export const intro = `I love the web, but I spent a large portion of the last few years woking on
...
export const date = "5/30/2020";
export const title = "Universal Applications vs. Universal Components";

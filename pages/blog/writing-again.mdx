...
actually gone through a few iterations of this. So I thought I thought it might
be fun to explain how I got here.

## The Tech Stack

- **TypeScript**: I _LOVE_ writing code in TypeScript! It's a tool that I feel
  makes mea better engineer because I am able to actually get all the thoughts

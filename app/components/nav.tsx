    ...
    <aside className="mb-2 tracking-tight">
      <div className="lg:sticky lg:top-20">
        <nav
          ...
          id="nav"
        >
          <div className="flex flex-row space-x-0 items-center w-full">
            {Object.entries(navItems).map(([path, { name }]) => {
              return (
                <Link
                  ...
                  key={path}
                  href={path}
                  className="transition-all hover:text-neutral-800 dark:hover:text-neutral-200 flex align-middle relative py-1 pr-4"
                >
                  {name}
                </Link>
              );
